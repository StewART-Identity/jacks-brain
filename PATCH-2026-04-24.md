...
> **Note (May 19, 2026):** Since this patch note was written, the
> top-level menu has been refactored: "Learn" has been split into
> "Collect" and "Search", "Collection" has been renamed to "Reflect",
> and an "Application" section has been added. Path references in
> this file have been kept as they were originally written for
> historical accuracy. See `PATCH-2026-05-19.md` for the more recent
> changes.
...
content/learn/retention.md             — was content/learn/memory.md; mounts RetentionList
