...
- **`CLAUDE.md`** — brought into alignment with the actual wiki:
  - Removes the "Master catalog" framing from `content/index.md`. The
    wiki uses per-category index files (`recall/sources/index.md`,
    `recall/concepts/index.md`, etc.) as the actual catalogs;
...
- [ ] `/recall/sources` loads the SourcesList table without a "Could
