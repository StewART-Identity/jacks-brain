...
An LDAP URL is a URI in the `ldap://` scheme that encodes a complete [[reflect/concepts/ldap|LDAP]] search operation — or a referral target — as a single, self-contained string. The format is defined by [[reflect/sources/2026-05-02-rfc4516-txt|RFC 4516]] (June 2006, part of the [[reflect/sources/2026-05-02-rfc4510-txt|RFC 4510]] series), which obsoletes [[reflect/sources/2026-05-02-rfc2255-txt|RFC 2255]] (December 1997).
...
The `<extensions>` component provides forward extensibility through OID-identified type=value pairs. Extensions implement a criticality contract matching [[reflect/concepts/ldap-controls|LDAP controls]]:
...
| Search filter string | [[reflect/sources/2026-05-02-rfc4515-txt\|RFC 4515]] | `<filter>` component |
| Attribute selector | [[reflect/sources/2026-05-02-rfc4511-txt\|RFC 4511]] §4.5.1 | `<attributes>` component |
...
See [[reflect/sources/2026-05-02-rfc4513-txt|RFC 4513]] for authentication guidance.

## Historical Note: RFC 2255 (1997)

The [[reflect/sources/2026-05-02-rfc2255-txt|original LDAP URL format]] was defined in RFC 2255 (December 1997) by [[reflect/entities/tim-howes|Tim Howes]] and [[reflect/entities/mark-smith|Mark Smith]] of [[reflect/entities/netscape-communications|Netscape Communications Corp.]], as part of the December 1997 LDAPv3 cluster. RFC 4516 (2006) obsoleted it with the following key changes:
