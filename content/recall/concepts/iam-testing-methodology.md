...
A second reading of the Rollout Plan ([[recall/sources/2026-04-19-2026-04-18-entra-authentication-methods-rollout-plan-final]]) reveals that the methodology, when executed, produces not a single gate but a three-gate nested structure: the pre-production Part 0 Go/No-Go, a Part 1 → Part 2 mid-deployment checkpoint, and a report-only → enforced enforcement ramp within Part 2 itself. See [[recall/concepts/go-no-go-gate]] for the full structure.
