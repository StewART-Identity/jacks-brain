...
| Scenario | Better fit |
|----------|-----------|
| Enterprise SSO across internal apps | [[recall/concepts/saml|SAML]] |
| API access with scoped permissions | [[recall/concepts/oauth|OAuth]] |
| Third-party app integration | [[recall/concepts/oauth|OAuth]] |
| Mobile / SPA auth | OAuth + OIDC |
| Legacy enterprise software (HR, ERP) | [[recall/concepts/saml|SAML]] |
...
Primary reference: [[recall/sources/2026-04-23-img-2369|SAML vs. OAuth Diagram]] — a side-by-side flow diagram from the "Reco" learning resource.
