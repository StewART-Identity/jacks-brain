---
title: "Brain Anatomy"
summary: "The structural organization of the human brain — cerebrum, brainstem, cerebellum, lobes, deep structures, and their respective functions."
type: concept
created: 2026-05-18
updated: 2026-05-18
subjects:
...
The cerebrum is the largest division, comprising the **cerebral cortex** (outer gray matter) and white matter at its core. It is responsible for movement initiation and coordination, temperature regulation, speech, judgment, reasoning, problem-solving, emotion, learning, and sensory processing.

### Cerebral cortex

The cortex (Latin: "bark") is the deeply folded outer layer — its folds (gyri and sulci) maximize surface area within the skull. It constitutes roughly half of the brain's mass. The cortex is divided into two **hemispheres** joined by the **corpus callosum**, a C-shaped white matter structure. Right hemisphere controls left-side body movement and sensation; left hemisphere controls right-side.
...
See [[collection/concepts/central-nervous-system]] for the spinal cord's role as the medulla's downstream conduit.

## Cerebellum

The cerebellum ("little brain") sits at the back of the head, below the temporal and occipital lobes. Like the cerebrum, it has two hemispheres. Its primary roles are coordinating voluntary muscle movement and maintaining posture, balance, and equilibrium. Emerging research links it to thought, emotion, social behavior, and conditions including addiction, autism, and schizophrenia.
...
Three membranous layers protect the brain and spinal cord:

1. **Dura mater** (outermost): thick and tough; includes two sub-layers with venous/arterial passageways.
2. **Arachnoid mater**: thin, weblike, avascular; CSF circulates in the space below it.
3. **Pia mater** (innermost): thin membrane that closely follows the brain's surface; richly vascularized.

## Blood supply

Two arterial systems supply the brain with oxygen:

- **Carotid arteries** — internal branches circulate blood to the anterior brain.
- **Vertebral arteries** — travel up the spinal column, join at the brainstem as the **basilar artery**, supplying the posterior brain.
- **Circle of Willis** — a loop near the base of the brain connecting both systems, enabling front-to-back redistribution and collateral circulation.

## Cranial nerves

Twelve cranial nerves originate inside the skull. The first two (olfactory, optic) arise from the cerebrum; the remaining ten emerge from the brainstem. See the full table in [[collection/sources/2026-05-18-brain-anatomy-and-how-the-brain-works-johns-hopkins-medicine]].
