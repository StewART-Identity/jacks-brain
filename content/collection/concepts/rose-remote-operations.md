...
ROSE is the operation-invocation layer that [[collection/concepts/x500-distributed-directory|X.500 directory]] protocols use for all substantive requests. Once [[collection/concepts/acse|ACSE]] has established an application association:
...
X.880 defines [[collection/concepts/asn1|ASN.1]] information object classes (X.681 constructs) for typed operation definitions:
...
The [[collection/sources/2026-05-04-t-rec-x-imp200-200612-i-msw-e|OSI Implementers' Guide v1.1]] records significant corrections to X.880 and X.882, all resolved in Technical Corrigendum 1 (07/1995):
