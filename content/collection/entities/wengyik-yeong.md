...
Yeong does not appear in the later LDAPv3 authorship clusters (RFC 2251 series, December 1997; RFC 4510 series, June 2006). The LDAPv3 effort shifted primary authorship to [[collection/entities/netscape-communications|Netscape Communications]] (where [[collection/entities/tim-howes|Howes]] had moved by 1997) and [[collection/entities/isode-ltd|Isode Limited]] ([[collection/entities/steve-kille|Kille]]'s organization under its later name).
