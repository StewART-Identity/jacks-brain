...
**ISO/IEC Joint Technical Committee 1, Subcommittee 6** (JTC 1/SC 6) is the ISO/IEC body responsible for telecommunications and information exchange between systems. In the context of directory standards, SC 6 is the ISO/IEC counterpart to [[collection/entities/itu-t|ITU-T]] Study Group 17 for the joint publication of the **X.500 directory series** as ISO 9594 International Standards.
...
Within JTC 1/SC 6, the Directory working group is **WG 7** (Information Systems). The ISO Rapporteur for Directory (the editor of the Directory Implementors' Guide) coordinates defect reports on the ISO side. [[collection/entities/hoyt-kesterson|Hoyt L. Kesterson II]] served as ISO/IEC Directory Rapporteur and Defect Report Editor for the 3rd and 4th edition periods.

## Relationship to LDAP

The [[collection/concepts/ldap|LDAP]] protocol and its RFC series are developed in the IETF rather than ITU-T or ISO/IEC. However, LDAP inherits its data model — [[collection/concepts/distinguished-name|distinguished names]], attribute types, [[collection/concepts/ldap-object-classes|object classes]] — directly from the X.500 series. RFC 2256 (superseded by RFC 4519) explicitly draws attribute types and object classes from X.501, X.520, X.521, and X.509 as produced by this joint standardization process.
