...
The [[collection/synthesis/x500-ldap-convergence|X.500/LDAP divergence narrative]] focuses on protocol and data model differences: OSI stacks vs. TCP/IP, DAP vs. LDAP, chaining vs. referrals. A less-discussed dimension is the **management layer**. X.500 defined, via [[collection/sources/2026-05-04-t-rec-x-530-200811-i-pdf-e|X.530 (ISO/IEC 9594-10)]], a complete normative framework for administering directory infrastructure. [[collection/concepts/ldap|LDAP]] never standardized an equivalent. This gap persists today in every LDAP deployment.

## What X.530 Provides

[[collection/concepts/x500-directory-management|X.500 directory management]] (X.530) defines:

1. **A formal managed object model** for every major directory component: [[collection/concepts/x500-distributed-directory|DSA]], DUA, [[collection/concepts/x500-directory-replication|Shadowing Agreement]], Hierarchical Operational Bindings (HOB/NHOB), Directory Service, Directory Customer, Directory User, and DMD.
...
4. **A standard management protocol**: [[collection/concepts/osi-systems-management|CMIP/CMIS]] (X.710/X.711) — an OSI application-layer protocol for get, set, action, create, delete, and event-report operations on managed objects.
...
The X.500 vision of directory management — formal, layered, interoperable, protocol-defined — remains unrealized in the LDAP world that succeeded it. See [[collection/concepts/x500-directory-management|X.500 Directory Management]] for X.530's full model, and [[collection/synthesis/x500-ldap-convergence|X.500 and LDAP Convergence]] for the broader divergence and partial reconvergence narrative.
