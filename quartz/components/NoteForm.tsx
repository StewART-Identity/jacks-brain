 ...
 * creates new notes. The list-and-edit side lives in NotesList.
 *
 * The DOM ids (note-title, note-tags, note-body, etc.) match the
 * original so the markdown-preview and tab-toggle logic in the inline
 * script ports over unchanged. The wrapping element id (#note-form-app)
 * is what scopes the inline script to this page only.
 */
const NoteForm: QuartzComponent = ({ displayClass }: QuartzComponentProps) => {
  return (
    <div class={displayClass} id="note-form-app">
      <div class="catalog-card">
        <h3 class="section-label">New note</h3>
