 ...
 *
 * Notes live at content/notes/entries/<slug>.md where slug is an ISO
 ...
 *
 * The 'entries' subfolder isolates notes from the Notes section landing
 * page (Write, Browse) so the folder listing on /notes/ doesn't show
 * actual notes alongside the section pages. Journal uses the same
 * pattern (content/journal/entries/) — see functions/api/journal.ts.
 *
